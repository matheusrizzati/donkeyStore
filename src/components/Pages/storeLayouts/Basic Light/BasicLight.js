...
function BasicLight(props){
    ...
    const notify = (item) => toast.success(`${item} adicionado ao carrinho`, {position: "bottom-right", autoClose: 3000, hideProgressBar: false, closeOnClick: true, pauseOnHover: true, draggable: true, progress: undefined, theme: "light"})
